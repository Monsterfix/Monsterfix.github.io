(function () {
  ...
  class FBUBBLE_Bps extends HTMLElement {
    constructor() {
      ...
      this._shadowRoot
        .getElementById("bps_valDecimal")
        .addEventListener("input", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("bps_sizeDecimal")
        .addEventListener("input", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("bps_colorDecimal")
        .addEventListener("input", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("bps_xAxisLabel")
        .addEventListener("input", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("bps_sizeLabel")
        .addEventListener("input", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("bps_colorLabel")
        .addEventListener("input", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("bps_data_submit")
        .addEventListener("click", this._formSubmit.bind(this));
    }
    _formSubmit(e) {
      e.preventDefault();
      this._shadowRoot
  ...
  customElements.define("com-kks-d3forcebubble-bps", FBUBBLE_Bps);
})();
