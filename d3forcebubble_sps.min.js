(function () {
  ...
  class FBUBBLE_Sps extends HTMLElement {
    constructor() {
      ...
      this._shadowRoot
        .getElementById("sps_showTitle")
        .addEventListener("change", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("sps_showAvg")
        .addEventListener("change", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("sps_startColor")
        .addEventListener("change", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("sps_endColor")
        .addEventListener("change", this._formSubmit.bind(this));
      this._shadowRoot
        .getElementById("sps_title")
        .addEventListener("change", this._formSubmit.bind(this));
    }
    _formSubmit(e) {
      e.preventDefault();
  ...
  customElements.define("com-kks-d3forcebubble-sps", FBUBBLE_Sps);
})();
